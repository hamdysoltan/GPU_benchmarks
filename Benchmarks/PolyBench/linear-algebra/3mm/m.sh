...
# For Memories
nv-nsight-cu-cli   --kernel-id ::regex:^.*$STR$:  --csv  --metrics  sm__warps_active.avg.pct_of_peak_sustained_active,sm__ctas_launched.sum   ./$exec_file  >>$file_01
 
nv-nsight-cu-cli   --kernel-id ::regex:^.*$STR$:  --csv  --metrics  l1tex__t_sector_hit_rate.pct,l1tex__t_sector_pipe_lsu_mem_global_op_ld_hit_rate.pct,lts__t_sector_hit_rate.pct ,lts__t_sector_op_read_hit_rate.pct   ./$exec_file  >>$file_01
