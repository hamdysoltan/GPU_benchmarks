		...
		DATA_TYPE POLYBENCH_2D(G_outputFromGpu,NI,NL,ni,nl))
{
	...
	printf("\n\n\n For Kernel 1: \n");
	printf("Grid_size is = (%d,%d)  \t Block size (x,y) is  (%d,%d) \n",grid1,DIM_THREAD_BLOCK_X,DIM_THREAD_BLOCK_Y);
	printf("\n\n For Kernel 2: \n");
	printf("Grid_size is = (%d,%d)  \t Block size (x,y) is  (%d,%d) \n",grid2,DIM_THREAD_BLOCK_X,DIM_THREAD_BLOCK_Y);
	printf("\n\n\n For Kernel 3: \n");
	printf("Grid_size is = (%d,%d)  \t Block size (x,y) is  (%d,%d) \n",grid3,DIM_THREAD_BLOCK_X,DIM_THREAD_BLOCK_Y);
